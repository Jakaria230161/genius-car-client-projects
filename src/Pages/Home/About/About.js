    ...
    <div className="hero my-20">
      <div className="hero-content flex-col lg:flex-row">
        <div className='relative w-1/2'>
          <img src={person} className="w-4/5 h-full rounded-lg shadow-2xl" alt='person pic' />
          <img src={parts} className="absolute w-3/5 right-5 top-1/2 border-t-pink-800 rounded-lg shadow-2xl" alt='parts pic' />
        </div>
        <div className='w-1/2'>
